...
drop table if exists loosebox_idisc.`commentreplynotice`;
create table loosebox_idisc.`commentreplynotice`
(
    commentreplynoticeid INTEGER(8) AUTO_INCREMENT not null primary key,
