...
public class SearchDaoTest extends TestStub {
    ...
    public void test() {
        ...
        final List<String> cols = Arrays.asList("author", "title", "categories", "description");//new GetColumnNamesOfType(jpa.getMetaData()).apply(Feed.class, String.class);
System.out.println("Columns: " + cols);        
        try(final SearchDao instance = new SearchDao(jpa, Feed.class, 0, 3, query, cols.toArray(new String[0]))) {
